...
VALUES
    ('John', 'Doe', 28, 'Male', 'john.doe@example.com', '555-123-4567', '1995-05-15', 'https://example.com/avatar1.jpg', 'State University', 'user', 'johndoe', 'hashed_password_1'),
    ('Jane', 'Smith', 24, 'Female', 'jane.smith@example.com', '555-987-6543', '1999-08-21', 'https://example.com/avatar2.jpg', 'Tech Institute', 'user', 'janesmith', 'hashed_password_2'),
    ('Michael', 'Brown', 32, 'Male', 'michael.brown@example.com', '555-456-7890', '1991-03-10', 'https://example.com/avatar3.jpg', 'City College', 'admin', 'mikebrown', 'hashed_password_3'),
    ('Emily', 'Johnson', 27, 'Female', 'emily.johnson@example.com', '555-234-5678', '1996-11-30', 'https://example.com/avatar4.jpg', 'National University', 'user', 'emilyjohn', 'hashed_password_4'),
    ('David', 'Wilson', 35, 'Male', 'david.wilson@example.com', '555-876-5432', '1988-09-22', 'https://example.com/avatar5.jpg', 'Liberal Arts College', 'user', 'davewilson', 'hashed_password_5');
...
VALUES
    (1, 'Morning Run', 'Great 5k run through the park', 'running', '2023-06-10T08:30:00Z', 
        '{"distance": 5, "duration": 25, "pace": "5:00", "calories": 350}', 5, 3, 'https://example.com/run1.jpg'),
    (2, 'Yoga Session', 'Relaxing evening yoga session', 'yoga', '2023-06-09T18:00:00Z', 
        '{"duration": 45, "calories": 180, "poses": 12}', 8, 2, 'https://example.com/yoga1.jpg'),
    (3, 'Weightlifting', 'New personal record on bench press', 'strength', '2023-06-08T14:15:00Z', 
        '{"sets": 5, "reps": 5, "weight": 225, "calories": 400}', 12, 5, 'https://example.com/lift1.jpg'),
    (4, 'Cycling Trip', 'Weekend ride along the coast', 'cycling', '2023-06-11T10:00:00Z', 
        '{"distance": 30, "duration": 90, "speed": 20, "elevation": 450, "calories": 800}', 15, 7, 'https://example.com/cycle1.jpg'),
    (5, 'Swimming', 'Lap swimming at the community pool', 'swimming', '2023-06-07T07:00:00Z', 
        '{"distance": 2, "duration": 45, "strokes": 1200, "calories": 500}', 6, 3, 'https://example.com/swim1.jpg');
