...
var filteredActivities = (0, vue_1.computed)(function () {
    var currentUser = userStore_1.userStore.currentUser();
    return activityStore_1.activityStore.activities.value.filter(function (activity) { return activity.user.name === currentUser; });
});
(0, vue_1.onMounted)(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            ...
            activityStore_1.activityStore.error.value = 'Failed to load your activities';
            console.error(err);
        }
        return [2 /*return*/];
    });
...
if (__VLS_ctx.activityStore.loading.value) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({});
    (__VLS_ctx.userStore.currentUser());
}
else {
    ...
    for (var _i = 0, _a = __VLS_getVForSourceType((__VLS_ctx.filteredActivities)); _i < _a.length; _i++) {
